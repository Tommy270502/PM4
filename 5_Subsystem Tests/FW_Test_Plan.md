...
| FW-08 | **Signed frequency, negative, low band** | Apply $I(t) = 1.5 \text{ V} + (A/2) \cdot \cos(2πft)$, $Q(t) = 1.5 \text{ V} - (A/2) \cdot \sin(2πft)$ with **f = 0.391 Hz**. Run at **A = 50 mVpp** and **A = 3.0 Vpp** | Dominant spectral peak is at **-0.391 Hz ± 1 bin**. The positive side does not become dominant. Spectrum and numerical peak readout are stable | -0.391 Hz | <span style="color:green;">**passed**</span> | --- |
